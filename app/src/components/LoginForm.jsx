...
<h2 className="text-3xl font-bold text-eerie-black md:text-4xl ">User Login</h2>
  <div className="mb-6 w-11/12 md:w-4/12 ">
    ...
    <input type="email" id="email" className="bg-white border border-gray-300 text-eerie-black text-sm rounded-lg focus:ring-robin-egg-blue focus:border-robin-egg-blue block w-full p-2.5 " placeholder="name@stud.ntnu.no" required/>
  </div>
  <div className="mb-6 w-11/12 md:w-4/12">
    <label htmlFor="password" className="block mb-2 text-sm font-medium text-eerie-black ">Your password</label>
    <input type="password" id="password" className="bg-white border border-gray-300 text-eerie-black text-sm rounded-lg focus:ring-robin-egg-blue focus:border-robin-egg-blue block w-full p-2.5 " required/>
  </div>
