...
function Footer() {
  return (
    <div className=" fixed bottom-0 left-0 z-20 w-full p-4 bg-ghost-white border-t border-slate-300  shadow md:flex md:items-center md:justify-between md:p-6  md:w-screen ">
